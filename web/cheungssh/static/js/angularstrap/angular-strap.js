        ...
        .provider('$alert', function () {
            ...
            this.$get = ["$modal", "$timeout", function ($modal, $timeout) {
                ...
                function AlertFactory(config) {
                    ...
                    $alert.$scope.selfClose = function(){
                        $alert.hide();
                        isExsits = false;
                    }

                    $alert.$scope.$on(options.prefixEvent + '.hide',function(){
                        isExsits = false;
                    });
                ...
                function ModalFactory(config) {
                    ...
                    scope.$hide = function () {
                        ...
                        if(options.cancelCallback)
                            options.cancelCallback(options.element,scope);
                        else if(scope.cancelCallback)
                            scope.cancelCallback(options.element,scope);
                    };
                    scope.$show = function () {
                        scope.$$postDigest(function () {
                            $modal.show();
                    ...
                    var backdropElement = options.prefixClass == 'alert'?angular.element(".alert-container"):angular.element('<div class="' + options.prefixClass + '-backdrop"/>');
                    ...
                    $modal.destroy = function () {
                        ...
                        if (options.prefixClass!='alert'&&backdropElement) {
                    ...
                    $modal.show = function () {
                        ...
                        if (options.backdrop&&options.prefixClass != 'alert') {
            ...
            this.$get = ["$window", "$rootScope", "$tooltip", function ($window, $rootScope, $tooltip) {
                ...
                function TypeaheadFactory(element, controller, config) {
                    ...
                    $typeahead.select = function (index) {
                        if(index == -1) return;
                        var value;
                      value = scope.$matches[index].value;
